...
fn infer_trait_assoc_method_generics_2() {
    check_infer(
        ...
        expect![[r#"
            134..312 '{     ...e(); }': ()
            144..145 'a': (u32, i64)
            148..162 'S::make::<i64>': fn make<i64, S, u32>() -> (u32, i64)
            148..164 'S::mak...i64>()': (u32, i64)
            174..175 'b': (u32, i64)
            188..195 'S::make': fn make<i64, S, u32>() -> (u32, i64)
            188..197 'S::make()': (u32, i64)
            207..208 'c': (u32, i64)
            211..232 'G::<u3...:<i64>': fn make<i64, G<u32>, u32>() -> (u32, i64)
            211..234 'G::<u3...i64>()': (u32, i64)
            244..245 'd': (u32, i64)
            258..272 'G::make::<i64>': fn make<i64, G<u32>, u32>() -> (u32, i64)
            258..274 'G::mak...i64>()': (u32, i64)
            284..285 'e': (u32, i64)
            300..307 'G::make': fn make<i64, G<u32>, u32>() -> (u32, i64)
...
fn infer_trait_assoc_method_generics_5() {
    check_infer(
        ...
        expect![[r#"
            ...
            120..149 '<S as ...::<u8>': fn make<u8, S<u64>, i64>() -> (S<u64>, i64, u8)
            120..151 '<S as ...<u8>()': (S<u64>, i64, u8)
            161..162 'b': (S<u64>, i64, u8)
            181..205 'Trait:...::<u8>': fn make<u8, S<u64>, i64>() -> (S<u64>, i64, u8)
